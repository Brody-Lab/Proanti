...
pop=matpfc;
pop_err_ap=matpfc_err_ap;
pop_err_choice=matpfc_err_choice;
...
for i=1:n_iterations
    ...
    for tx=1:length(centers) %look over different time points
        ...
        res_choice_pfc_err(i,tx)=mean([valp vala]);
...
save ../data_files/svm_results_pfc res_ap_pfc res_ap_pfc_err ...
    res_choice_pfc res_choice_pfc_err centers
